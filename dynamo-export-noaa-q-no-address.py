...
def mysql_batch_insert(batch_data,dbCusrsor,noaaDB):
    sql = "INSERT INTO NOAAQNoAddress (Email,LenderApiKey,DTCreated,SSNHash) VALUES (%s,%s,%s,%s)"
...
def parallel_scan(tableName, totalsegments, threadsegment):
    ...
    for data in response['Items']:        
        ...
        insterData = (formatted_data['Email'],data['LenderApiKey'], data['DTCreated'], data['SSNHash'])
