...
def mysql_batch_insert(batch_data,dbCusrsor,noaaDB):
    sql = "INSERT INTO NOAAQEmailOversightLogs (Email,CreatedAt,DTCreated,LenderApiKey,Response,TLEName) VALUES (%s,%s,%s,%s,%s,%s)"
...
def parallel_scan(tableName, totalsegments, threadsegment):
    ...
    for data in response['Items']:        
        ...
        insterData = (formatted_data['Email'],data['CreatedAt'], data['DTCreated'], data['LenderApiKey'],data['Response'],data['TLEName'])
...
if __name__ == "__main__":
    ...
    tablename = "NOAAQEmailOversightLogs"
    total_segments = 10
