...
def mysql_batch_insert(batch_data,dbCusrsor,noaaDB):
    sql = "INSERT INTO NOAAQ (SSNHash,BureauID,Email,FirstName,LastName) VALUES (%s,%s,%s,%s,%s)"
...
def parallel_scan(tableName, totalsegments, threadsegment):
    ...
    for data in response['Items']:        
        ...
        insterData = (formatted_data['SSNHash'],data['BureauID'], data['Email'], data['FirstName'],data['LastName'])
